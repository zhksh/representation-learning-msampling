...
if __name__ == '__main__':
    ...
    if conf.class_mode == 'cls':
        model = DistilBertSentimentCLS(conf, num_classes)
    elif conf.class_mode == 'avg':
        model = DistilBertSentimentAvg(conf, num_classes)
    ...
    accuracy = reference_model.evaluate(cross_evaluation_data_loader)
